...
- [1. 새로운 블로그를 시작하다](#1-새로운-블로그를-시작하다)
  - [1.1. 티스토리에서 깃허브 블로그로 갈아탄 이유](#11-티스토리에서-깃허브-블로그로-갈아탄-이유)
- [2. 깃허브 블로그 시작하기 (Start GitHub Blog)](#2-깃허브-블로그-시작하기-start-github-blog)
  - [2.1. 깃허브 가입](#21-깃허브-가입)
  - [2.2. 새 저장소 생성](#22-새-저장소-생성)
  - [2.3. 원하는 테마 고르기 (추천 테마)](#23-원하는-테마-고르기-추천-테마)
  - [2.4. 고른 테마 가져오기 (clone)](#24-고른-테마-가져오기-clone)
  - [2.5. _config.yml 알맞게 수정하기](#25-_configyml-알맞게-수정하기)
  - [2.6. GitHub Pages 설정하기](#26-github-pages-설정하기)
- [3. 간과된 것들](#3-간과된-것들)
